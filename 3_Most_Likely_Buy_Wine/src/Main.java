...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setMapperClass(SortWineMapper.class);
		// Setting a custom comparator to sort with descending order.
		job.setSortComparatorClass(SortMoneyComparator.class);
		// Setting the reducer for the job.
		job.setCombinerClass(SortWineReducer.class);
		job.setReducerClass(SortWineReducer.class);
		...
		// Setting a custom comparator to sort with descending order.
		job2.setSortComparatorClass(RankComparator.class);
